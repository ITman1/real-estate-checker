package cloudcode.realitychecker;
...
public class RealityCheckerApplication {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RealityCheckerApplication.class);
    ...
    public static void main(final String[] args) throws Exception {
        ...
        SpringApplication app = new SpringApplication(RealityCheckerApplication.class);
